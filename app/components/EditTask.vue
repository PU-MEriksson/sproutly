...
const props = defineProps<{ task: Database["public"]["Tables"]["tasks"]["Row"] }>();
const emit = defineEmits<{ updated: [task: Database["public"]["Tables"]["tasks"]["Row"]] }>();


// Calendar value for start date
const startDateValue = ref<DateValue | undefined>(toCalendarDate(props.task.startdate ?? undefined));
